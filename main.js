...
function execute() {
    ...
    programCounter = 1;
    if (encodeURIComponent(document.getElementsByTagName('textArea')[0].value) !== getUrlVars()["text"] || encodeURIComponent(document.getElementById('input')) !== decodeURIComponent(getUrlVars()["input"]))) {
